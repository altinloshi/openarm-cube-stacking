"""Command-line helpers for the local RSL-RL scripts."""
...
def add_rsl_rl_args(parser: argparse.ArgumentParser) -> None:
    """Add common RSL-RL command-line arguments."""
    ...
    arg_group.add_argument("--run_name", type=str, default=None, help="Optional suffix for the run directory.")
    ...
    arg_group.add_argument("--checkpoint", type=str, default=None, help="Checkpoint file path.")
    arg_group.add_argument(
        "--logger",
        type=str,
        default=None,
        choices={"wandb", "tensorboard", "neptune"},
        help="Optional experiment logger.",
    )
    arg_group.add_argument(
        "--log_project_name",
        type=str,
        default=None,
        help="Project name when using wandb or neptune logging.",
    )
